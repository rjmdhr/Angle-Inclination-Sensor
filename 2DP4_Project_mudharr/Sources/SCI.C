...
/*The following SCI_Init portion was edited for a bus clock of 8MHZ*/
/*Modified by Raj Mudhar, mudharr, 400088877 for 2DP4 project*/
...
// baudRate =  9600 bits/sec   SCI0BDL=52
// baudRate =  19200 bits/sec  SCI0BDL=26
// baudRate =  384000 bits/sec SCI0BDL=13
// baudRate = 57600 bits/sec SCI0BDL=9
// baudRate = 115200 bits/sec SCI0BDL=4
// sets baudRate to 19200 bits/sec if doesn't match one of the above
void SCI_Init(unsigned short baudRate){
  ...
  switch(baudRate){
    ...
    case 57600: SCI0BDL=9;  break;
    case 115200: SCI0BDL=4;  break;
    default:    SCI0BDL=13;  //38400 
  }
  SCI0CR1 = 0;
/* bit value meaning
